...
<div class="c-page-block">
  <h1 class="u-text--center"><?php esc_html_e("Welcome, ", 'ccw_countries'); echo $_GET['username']; ?></h1>
  ...
  <div class="c-grid c-grid--h-center">
    <div class="c-col c-col--6">
      <div class="c-content-panel">
        ...
        echo $templates->render('info', ['message' => __('Your username is ', 'ccw_countries')  . '<span class="u-color--yellow">'
