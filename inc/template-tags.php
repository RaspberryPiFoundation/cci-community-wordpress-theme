 ...
 */
function ccw_countries_category_transient_flusher() {
	if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) {
		return;
	}
	// Like, beat it. Dig?
	delete_transient( 'ccw_countries_categories' );
}
add_action( 'edit_category', 'ccw_countries_category_transient_flusher' );
add_action( 'save_post',     'ccw_countries_category_transient_flusher' );
